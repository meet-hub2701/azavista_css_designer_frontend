      ...
      <div className="flex h-screen bg-white font-sans">
        ...
        <div className="flex-1 overflow-auto">
          <div className="max-w-4xl mx-auto p-8">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-slate-900 mb-2">Section List</h1>
              <p className="text-slate-600">Select a theme to view its sections</p>
            </div>

            {isLoading ? (
              <div className="text-center py-12">
                <div className="inline-block animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600"></div>
                <p className="mt-4 text-slate-600">Loading themes...</p>
              </div>
            ) : !themes || themes.length === 0 ? (
              <div className="text-center py-12 bg-white rounded-lg shadow-sm border border-slate-200">
                <div className="text-6xl mb-4">📦</div>
                <h3 className="text-xl font-semibold text-slate-900 mb-2">No themes yet</h3>
                <p className="text-slate-600 mb-6">Create a theme first to view sections</p>
                <button
